...
(function () {
  ...
  const BODY_PART_META = {
    chest: {
      label: "Chest",
      icon: `<svg viewBox="0 0 24 24" fill="none"><path class="muscle-base" d="M12 7.2c2.7 0 5 1.8 5.8 4.3.3 1-.1 2.1-.8 2.9l-2 2.2c-.8.9-2 1.4-3.2 1.4s-2.4-.5-3.2-1.4l-2-2.2c-.7-.8-1.1-1.9-.8-2.9.8-2.5 3.1-4.3 5.8-4.3z"/><path class="muscle-focus" d="M12 9c1.8 0 3.4 1.1 4 2.8.1.4 0 .8-.2 1.1l-1.4 1.6c-.6.6-1.5 1-2.3 1s-1.7-.4-2.3-1L8.4 13c-.2-.3-.3-.7-.2-1.1.6-1.7 2.2-2.8 4-2.8z"/></svg>`,
    },
    arms: {
      label: "Arms",
      icon: `<svg viewBox="0 0 24 24" fill="none"><rect class="muscle-base" x="4.3" y="8" width="5" height="8" rx="2.4"/><rect class="muscle-base" x="14.7" y="8" width="5" height="8" rx="2.4"/><rect class="muscle-focus" x="5.5" y="9.1" width="2.7" height="5.8" rx="1.2"/><rect class="muscle-focus" x="15.8" y="9.1" width="2.7" height="5.8" rx="1.2"/></svg>`,
    },
    abs: {
      label: "Abs",
      icon: `<svg viewBox="0 0 24 24" fill="none"><rect class="muscle-base" x="7.2" y="5.9" width="9.6" height="12.2" rx="3.4"/><rect class="muscle-focus" x="8.6" y="7.6" width="2.4" height="2.6" rx=".7"/><rect class="muscle-focus" x="13" y="7.6" width="2.4" height="2.6" rx=".7"/><rect class="muscle-focus" x="8.6" y="11" width="2.4" height="2.6" rx=".7"/><rect class="muscle-focus" x="13" y="11" width="2.4" height="2.6" rx=".7"/><rect class="muscle-focus" x="8.6" y="14.4" width="2.4" height="2.6" rx=".7"/><rect class="muscle-focus" x="13" y="14.4" width="2.4" height="2.6" rx=".7"/></svg>`,
    },
    back: {
      label: "Back",
      icon: `<svg viewBox="0 0 24 24" fill="none"><path class="muscle-base" d="M12 5.8c3.9 0 7 3.1 7 7v.4c0 1.2-.5 2.4-1.4 3.2l-2 1.9c-1 .9-2.2 1.4-3.6 1.4s-2.6-.5-3.6-1.4l-2-1.9c-.9-.8-1.4-2-1.4-3.2v-.4c0-3.9 3.1-7 7-7z"/><path class="muscle-focus" d="M12 7.8c2.8 0 5 2.2 5 5v.2c0 .7-.3 1.4-.8 1.9l-1.4 1.3c-.7.6-1.7 1-2.8 1s-2.1-.4-2.8-1l-1.4-1.3c-.5-.5-.8-1.2-.8-1.9v-.2c0-2.8 2.2-5 5-5z"/><rect class="muscle-focus" x="11.2" y="8.6" width="1.6" height="7.3" rx=".8"/></svg>`,
    },
    legs: {
      label: "Legs",
      icon: `<svg viewBox="0 0 24 24" fill="none"><path class="muscle-base" d="M8.1 5.9h3.2c.7 0 1.2.6 1.1 1.3l-.5 4.4c0 .5-.4.9-.8 1.1l-2.2.9c-.5.2-.8.7-.8 1.2v3.4c0 .8-.7 1.5-1.5 1.5H5.8c-.9 0-1.5-.8-1.5-1.6l.4-5.1c.1-1.4 1-2.6 2.3-3l.6-.2.5-3c.1-.5.5-.9 1-.9z"/><path class="muscle-base" d="M15.9 5.9h-3.2c-.7 0-1.2.6-1.1 1.3l.5 4.4c0 .5.4.9.8 1.1l2.2.9c.5.2.8.7.8 1.2v3.4c0 .8.7 1.5 1.5 1.5h.8c.9 0 1.5-.8 1.5-1.6l-.4-5.1c-.1-1.4-1-2.6-2.3-3l-.6-.2-.5-3c-.1-.5-.5-.9-1-.9z"/><rect class="muscle-focus" x="6.2" y="12.4" width="2.8" height="6.4" rx="1.2"/><rect class="muscle-focus" x="15" y="12.4" width="2.8" height="6.4" rx="1.2"/></svg>`,
    },
    delts: {
      label: "Delts",
      icon: `<svg viewBox="0 0 24 24" fill="none"><path class="muscle-base" d="M12 7.2c1.9 0 3.6.8 4.8 2.1l1.7 2c.6.7.8 1.8.4 2.7-.4.9-1.3 1.5-2.3 1.5h-1.2c-.8 0-1.5-.4-2-1l-1.4-1.8-1.4 1.8c-.5.6-1.2 1-2 1H7.4c-1 0-1.9-.6-2.3-1.5-.4-.9-.2-2 .4-2.7l1.7-2C8.4 8 10.1 7.2 12 7.2z"/><circle class="muscle-focus" cx="8.4" cy="10.7" r="2.2"/><circle class="muscle-focus" cx="15.6" cy="10.7" r="2.2"/></svg>`,
    },
