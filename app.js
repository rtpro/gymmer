...
(function () {
  ...
  const BODY_PART_META = {
    ...
    abs: {
      label: "Abs",
      icon: `<svg viewBox="0 0 24 24" fill="none"><circle class="muscle-base" cx="12" cy="4.6" r="2.1"/><rect class="muscle-base" x="8.6" y="7" width="6.8" height="8.6" rx="3.2"/><rect class="muscle-base" x="6" y="8" width="2.2" height="6.3" rx="1.1"/><rect class="muscle-base" x="15.8" y="8" width="2.2" height="6.3" rx="1.1"/><rect class="muscle-base" x="9.1" y="15" width="2.2" height="5.4" rx="1.1"/><rect class="muscle-base" x="12.7" y="15" width="2.2" height="5.4" rx="1.1"/><rect class="muscle-focus" x="10" y="8.7" width="4" height="5.9" rx="1.8"/><path class="muscle-focus" d="M10.6 9.7h2.8M10.6 11.2h2.8M10.6 12.7h2.8" stroke="currentColor" stroke-width=".9" stroke-linecap="round" opacity=".96"/></svg>`,
    },
    back: {
      label: "Back",
      icon: `<svg viewBox="0 0 24 24" fill="none"><circle class="muscle-base" cx="12" cy="4.6" r="2.1"/><rect class="muscle-base" x="8.6" y="7" width="6.8" height="8.6" rx="3.2"/><rect class="muscle-base" x="6" y="8" width="2.2" height="6.3" rx="1.1"/><rect class="muscle-base" x="15.8" y="8" width="2.2" height="6.3" rx="1.1"/><rect class="muscle-base" x="9.1" y="15" width="2.2" height="5.4" rx="1.1"/><rect class="muscle-base" x="12.7" y="15" width="2.2" height="5.4" rx="1.1"/><path class="muscle-focus" d="M9.6 7.9h4.8c.6 0 1.1.5 1.1 1.1v4.8c0 .6-.5 1.1-1.1 1.1H9.6c-.6 0-1.1-.5-1.1-1.1V9c0-.6.5-1.1 1.1-1.1z"/><path class="muscle-focus" d="M12 8.1v6.6" stroke="currentColor" stroke-width="1" stroke-linecap="round" opacity=".96"/></svg>`,
    },
    legs: {
      label: "Legs",
      icon: `<svg viewBox="0 0 24 24" fill="none"><circle class="muscle-base" cx="12" cy="4.6" r="2.1"/><rect class="muscle-base" x="8.6" y="7" width="6.8" height="8.6" rx="3.2"/><rect class="muscle-base" x="6" y="8" width="2.2" height="6.3" rx="1.1"/><rect class="muscle-base" x="15.8" y="8" width="2.2" height="6.3" rx="1.1"/><rect class="muscle-base" x="9.1" y="15" width="2.2" height="5.4" rx="1.1"/><rect class="muscle-base" x="12.7" y="15" width="2.2" height="5.4" rx="1.1"/><rect class="muscle-focus" x="8.9" y="14.9" width="2.6" height="5.7" rx="1.2"/><rect class="muscle-focus" x="12.5" y="14.9" width="2.6" height="5.7" rx="1.2"/></svg>`,
    },
    delts: {
      label: "Delts",
      icon: `<svg viewBox="0 0 24 24" fill="none"><circle class="muscle-base" cx="12" cy="4.6" r="2.1"/><rect class="muscle-base" x="8.6" y="7" width="6.8" height="8.6" rx="3.2"/><rect class="muscle-base" x="6" y="8" width="2.2" height="6.3" rx="1.1"/><rect class="muscle-base" x="15.8" y="8" width="2.2" height="6.3" rx="1.1"/><rect class="muscle-base" x="9.1" y="15" width="2.2" height="5.4" rx="1.1"/><rect class="muscle-base" x="12.7" y="15" width="2.2" height="5.4" rx="1.1"/><circle class="muscle-focus" cx="8" cy="9.8" r="1.8"/><circle class="muscle-focus" cx="16" cy="9.8" r="1.8"/></svg>`,
    },
